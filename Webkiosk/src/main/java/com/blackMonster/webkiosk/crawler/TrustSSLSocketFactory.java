    ...
    public TrustSSLSocketFactory(KeyStore truststore) throws NoSuchAlgorithmException, KeyManagementException, KeyStoreException, UnrecoverableKeyException {
        ...
        TrustManager tm = new X509TrustManager() {
            ...
            public void checkServerTrusted(X509Certificate[] chain, String authType) throws CertificateException {
                if (chain[0].getIssuerDN().getName().equals("CN=DigiCert SHA2 Secure Server CA,O=DigiCert Inc,C=US") &&
                        chain[0].getSubjectDN().getName().equals("CN=webkiosk.jiit.ac.in,O=jaypee institute of information technology University,L=Noida,ST=Uttar Pradesh,C=IN")) {
                    return;
                }
