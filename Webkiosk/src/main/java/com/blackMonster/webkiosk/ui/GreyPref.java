 ...
 */
public class GreyPref extends Preference {

	public GreyPref(Context context) {
		super(context);
	}
	
	public GreyPref(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
	public GreyPref(Context context, AttributeSet attrs, int defStyle) {
